...
if ( ! class_exists( 'WPSEO_Local_Metaboxes' ) ) {
	...
	class WPSEO_Local_Metaboxes {
		 ...
		 * @param array<string, string|int|bool|array<string, string|array<string, string>>|array<string>|null>|string $default_meta The default to return if the key doesn't exist.
		 *
		 * @return array<string, string|int|bool|array<string, string|array<string, string>>|array<string>|null>|string The meta data or the default value if the passed key doesn't exist.
		 */
