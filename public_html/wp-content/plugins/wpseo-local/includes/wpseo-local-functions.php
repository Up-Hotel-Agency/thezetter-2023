...
function wpseo_has_primary_location() {
	...
	$result = ( wpseo_multiple_location_one_organization() && $location_id && $active );
	return $result;
}
...
function wpseo_is_current_location_identical_to_primary() {
	...
	if ( wpseo_has_primary_location() ) {
		$result = (int) WPSEO_Options::get( 'multiple_locations_primary_location' ) === (int) $place_data->post_id;
		return $result;
	}
	elseif ( wpseo_has_location_acting_as_primary() ) {
		...
		$result = (int) $id === (int) $place_data->post_id;
		return $result;
	}
...
function wpseo_schema_will_have_branch_organization( $is_company = false ) {
	...
	return ( $is_company && ( is_singular( $post_type ) && ! wpseo_is_current_location_identical_to_primary() ) );
}
